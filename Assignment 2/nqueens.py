...
def hill_climbing(board):
    ...
    compareConflicts = count_conflicts(board)
    print("Conflicting queens start " + str(compareConflicts) )
    ...
    while improvementCounter != 0:
        ...
        if prelConflicts < compareConflicts:
            print("Found improvement!")
            print_board(board)
            print("Conflicting queens " + str(prelConflicts) )
            compareConflicts = prelConflicts
            improvementCounter = 3
        else:
